...
inline void footer() noexcept
{
	...
	ImGui::textUnformattedCentered("Copyright (C) 2022-2023 Sheelia & R3nzTheCodeGOD");
}
...
void GUI::render() noexcept
{
	...
	ImGui::Begin("Sheelia & R3nzSkin TFT", nullptr, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_AlwaysAutoResize);
