...
namespace d3d_vtable {
	...
	static void init_imgui(void* device, bool is_d3d11 = false) noexcept
	{
		...
		colors[ImGuiCol_TitleBg] = ImVec4(0.18f, 0.54f, 0.27f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.18f, 0.54f, 0.27f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.18f, 0.54f, 0.27f, 1.00f);
